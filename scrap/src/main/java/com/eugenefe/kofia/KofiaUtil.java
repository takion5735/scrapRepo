...
public class KofiaUtil {
	private final static Logger logger = LoggerFactory.getLogger(KofiaUtil.class);	
	private static String url = "http://www.seibro.or.kr/websquare/engine/proworks/callServletService.jsp";
	
	private static String isinUrl = "http://dis.kofia.or.kr/proframeWeb/XMLSERVICES/";
	...
	public static Document getElsDataDoc(EKsdElsDataGroup dataType, String isin){
		...
		Document doc = Jsoup.parse(KofiaUtil.callSeveltService(elsReferer, payload), "",Parser.xmlParser());
...
//----------- specific Method ------------------------------
	public static Document getElsInfo(String isin){
		...
		Document doc = Jsoup.parse(KofiaUtil.callSeveltService(elsReferer, issueInfoPayload), "",Parser.xmlParser());
	...
	public static Document getElsStrikePrice(String isin){
		...
		Document doc = Jsoup.parse(KofiaUtil.callSeveltService(elsReferer, exerPayload),"", Parser.xmlParser());
		return doc;
	}
	...
	public static Document getElsSchedule(String isin){
		...
		Document doc = Jsoup.parse(KofiaUtil.callSeveltService(elsReferer, schedulePayload),"", Parser.xmlParser());
//		logger.info("Doc : {}", doc);
		return doc;
	}
	...
	public static Document getElsBaseInfo(String isin){
		...
		Document doc = Jsoup.parse(KofiaUtil.callSeveltService(elsReferer, baseInfoPayload),"", Parser.xmlParser());
		logger.info("Doc : {}", doc);
		return doc;
	}
