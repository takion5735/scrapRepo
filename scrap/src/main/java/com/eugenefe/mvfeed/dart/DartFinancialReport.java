...
public class DartFinancialReport implements Scrappable{
	...
	public boolean equals(Object obj) {
		if(obj instanceof DartFinancialReport){
			DartFinancialReport other = (DartFinancialReport)obj;
